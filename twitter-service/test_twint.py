#!/usr/bin/env python3
"""
Test script for Twint functionality
Run this to verify Twint is working correctly
"""
...
from main import search_via_twint
...
def test_twint():
    """Test Twint functionality with various queries"""
    test_queries = ["bitcoin", "ethereum", "crypto"]

    print("🧪 Testing Twint Twitter Scraping")
    print("=" * 50)
    ...
    for query in test_queries:
        ...
        try:
            tweets = search_via_twint(query, 5)
