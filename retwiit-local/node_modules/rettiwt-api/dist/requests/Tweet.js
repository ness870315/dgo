...
class TweetRequests {
     ...
     */
    static replies(id, cursor, sortBy) {
        return {
            method: 'get',
            ...
            params: {
                ...
                variables: JSON.stringify({
                    ...
                    referrer: 'tweet',
                    with_rux_injections: false,
                    rankingMode: sortBy ?? Tweet_1.RawTweetRepliesSortType.RELEVACE,
        ...
        return {
            ...
            params: {
                ...
                variables: JSON.stringify({
                    ...
                    product: parsedFilter.top ? Tweet_1.RawTweetSearchResultType.TOP : Tweet_1.RawTweetSearchResultType.LATEST,
