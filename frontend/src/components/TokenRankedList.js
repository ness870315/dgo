      ...
      <div className="space-y-2 p-2 sm:p-4">
        ...
        <div className="space-y-2 mobile-token-list">
          {sortedTokens.map((token, index) => {
            ...
            // Get 5m stats for Trenches filter
            const txns5m = isTrenchesFilter ? (token.jupiterData?.stats5m?.txns || 0) : 0;
            const makers5m = isTrenchesFilter ? (token.jupiterData?.stats5m?.makers || 0) : 0;
            const volume5m = isTrenchesFilter ? (token.jupiterData?.stats5m?.volume || 0) : 0;
                ...
                <div className="block sm:hidden mobile-token-box">
                  <div className="flex items-center justify-between py-2">
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0">
                      ...
                      {/* 5M Stats - Show only for Trenches filter */}
                      {isTrenchesFilter && (
                        <>
                          <div className="text-center">
                            <div className="text-white font-semibold text-xs">
