...
const CategoryFilters = ({ onFiltersChange, currentFilters }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-1 sm:space-y-0 sm:space-x-2 relative mobile-filters-container">
      <span className="text-gray-400 mr-0 sm:mr-2 flex-shrink-0 mobile-filters-label" style={{ fontSize: '10px' }}>Categories:</span>
          ...
          return (
            <div key={key} className="relative">
              <button
                ...
                className={`px-2 py-1 rounded font-medium transition-colors whitespace-nowrap mobile-filter-button ${
                  value
