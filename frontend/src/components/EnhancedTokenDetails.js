          ...
          <div className="flex-1 overflow-y-auto p-2 sm:p-4" style={{ height: 'calc(100vh - 80px)', display: 'flex', flexDirection: 'column' }}>
            <div className="grid grid-cols-12 gap-2 lg:gap-4" style={{ flex: '1 1 auto', minHeight: 0 }}>
              ...
              <div className="col-span-12 lg:col-span-3 bg-gray-800 rounded-lg lg:p-5" style={{ height: 'calc(100vh - 200px)', minHeight: '400px', maxHeight: 'calc(100vh - 200px)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                ...
                <div className="overflow-y-auto flex-1 p-4 lg:p-0" style={{ maxHeight: '100%' }}>
                  ...
                  <div className="pt-4 border-t border-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-4 text-[11px] lg:text-sm">
                      <div className="space-y-2 lg:space-y-3">
                        <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                          <div className="flex items-center justify-between gap-2">
                            <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                              💎 <span className="leading-tight">FDV</span>
                            </span>
                        ...
                        <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                          <div className="flex items-center justify-between gap-2">
                            <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                              📊 <span className="leading-tight">Volume (24h)</span>
                            </span>
                            <span className="text-white font-semibold text-sm lg:text-base">
                        ...
                        <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                          <div className="flex items-center justify-between gap-2">
                            <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                              📈 <span className="leading-tight">Price Change (24h)</span>
                            </span>
                      ...
                      <div className="space-y-2 lg:space-y-3">
                        <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                          <div className="flex items-center justify-between gap-2">
                            <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                              🎯 <span className="leading-tight">Organic Score</span>
                            </span>
                            <span className="text-white font-semibold text-sm lg:text-base">
                        ...
                        <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                          <div className="flex items-center justify-between gap-2">
                            <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                              💰 <span className="leading-tight">Total Supply</span>
                            </span>
                            <span className="text-white font-semibold text-sm lg:text-base">
                        ...
                        <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                          <div className="flex items-center justify-between gap-2">
                            <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                              🔄 <span className="leading-tight">Circulating Supply</span>
                            </span>
                            <span className="text-white font-semibold text-sm lg:text-base">
                  ...
                  <div className="pt-4 border-t border-gray-700">
                    ...
                    <div className="grid grid-cols-2 gap-3 lg:gap-4 mb-4 text-[11px] lg:text-sm">
                      {/* Community Type */}
                      <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                        <div className="flex items-center justify-between gap-2">
                          <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                            🌍 <span className="leading-tight">Community Type</span>
                          </span>
                          <span className={`px-2 py-1 rounded-full text-[10px] lg:text-sm font-medium ${
                      ...
                      <div className="bg-gray-900 rounded border border-gray-700 px-3 py-2">
                        <div className="flex items-center justify-between gap-2">
                          <span className="text-gray-400 whitespace-nowrap flex items-center gap-1">
                            🏷️ <span className="leading-tight">Official Profile</span>
                          </span>
                          <span className={`px-2 py-1 rounded-full text-[10px] lg:text-sm font-medium ${
              ...
              <div className="col-span-12 lg:col-span-6 xl:col-span-7" style={{ minHeight: '600px', height: 'calc(100vh - 200px)' }}>
                {/* Desktop/14-inch: Fixed height layout - CHART FIXED, SWAP TABLE BELOW */}
                <div className="hidden lg:flex flex-col h-full relative">
                  {/* CENTER-UP: Price Chart - FIXED HEIGHT - X-AXIS ALWAYS VISIBLE */}
                  <div className="bg-gray-800 rounded-lg flex flex-col" style={{ height: '400px', flexShrink: 0, marginBottom: '20px' }}>
                    <div className="flex-1 overflow-visible" style={{ padding: '0 0 60px 0', minHeight: '340px' }}>
                      <SVGChart token={token} onClose={null} />
                    </div>
                  </div>

                  {/* CENTER-DOWN: Swap Table - FLEXIBLE HEIGHT - STARTS BELOW CHART */}
                  <div className="bg-gray-800 rounded-lg flex flex-col border-2 border-green-500 flex-1" style={{ minHeight: '300px', flexShrink: 0 }}>
              ...
              <div className="col-span-12 lg:col-span-3 xl:col-span-2" style={{ minHeight: '600px', height: 'calc(100vh - 200px)' }}>
                {/* Desktop/14-inch: Fixed height layout - JUPITER FIXED, BUBBLEMAPS BELOW */}
                <div className="hidden lg:flex flex-col h-full relative">
                  {/* RIGHT-UP: Jupiter Integrated Plugin - FIXED HEIGHT - ALIGNED WITH CHART */}
                  <div className="bg-gray-800 rounded-lg flex flex-col" style={{ height: '400px', flexShrink: 0, marginBottom: '20px' }}>
                    ...
                    <div className="flex-1 overflow-hidden" style={{ minHeight: '350px', padding: '12px' }}>
                      <JupiterSwapWidget token={token} />
                    </div>
                  </div>

                  {/* RIGHT-BOTTOM: Bubblemaps - FLEXIBLE HEIGHT - ALIGNED WITH SWAP TABLE */}
                  <div className="bg-gray-800 rounded-lg border-2 border-gray-700 flex flex-col flex-1" style={{ minHeight: '300px', flexShrink: 0 }}>
